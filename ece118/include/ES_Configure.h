...
typedef enum {
    ...
    LIGHT_TODARK,
    LIGHT_TOLIGHT,
    BUMPER_CHANGE,         // Unique name for V1 of Bumper Event
    BUMPER_PRESS,
    BUMPER_RELEASE,
    SUB_SM_COMPLETE,
} ES_EventTyp_t;
...
#define DEBUG_FSM   0    // added by Nick Kuipers
...
#define EVENT_CHECK_LIST  checkBumpers, checkLight, TemplateCheckBattery
