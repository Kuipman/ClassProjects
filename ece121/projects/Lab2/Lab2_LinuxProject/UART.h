 ...
 *  @purpose Implements a UART device driver -- allows for an I/O stream between the
 *      physical and application layers of the PIC32/PC interface
...
#include "BOARD.h"
#include "LEDs.h" //Just for debugging purposes
#include <stdio.h>
#include <stdlib.h>
