...
#define LOW_VOLTAGE_LED_TRIS            TRISEbits.TRISE2        // PORT Z07
#define LOW_VOLTAGE_LED                 LATEbits.LATE2    
...
// Launcher Pin Definitions
#define FLYWHEEL_ON_TRIS        TRISBbits.TRISB13      // PORT Z9
#define FLYWHEEL_ON             LATBbits.LATB13      

// Stepper Motor Pins
#define STEPPER_PWM             PWM_PORTY04     // connected to input A
#define STEPPER_ENABLE_TRIS     TRISDbits.TRISD6   // CHANGE ASAP
#define STEPPER_ENABLE          LATDbits.LATD6     //change ASAP
