...
#define EVENT_CHECK_LIST  checkBumpers, checkTapeSensors, checkTrackWire, check2kBeacon, check1_5kBeacon, updateTOF      //TemplateCheckBattery
...
//#define TIMER0_RESP_FUNC PostBumperService    // Calls the bumper service upon timer expiry
//#define TIMER1_RESP_FUNC PostHSM              // Calls the Finite State Machine upon timer expiry
#define TIMER0_RESP_FUNC PostBumperService
#define TIMER1_RESP_FUNC PostHSM
#define TIMER2_RESP_FUNC TIMER_UNUSED         // Bumper Debounce Timer
...
#define BUMPER_DEBOUNCE_TIMER 0
#define HSM_TIMER             1
...
#if NUM_SERVICES > 2
// the header file with the public fuction prototypes
#define SERV_2_HEADER "TapeAndTrackService.h"
// the name of the Init function
#define SERV_2_INIT InitTapeAndTrackService
// the name of the run function
#define SERV_2_RUN RunTapeAndTrackService
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public fuction prototypes
#define SERV_4_HEADER "BOAT_HSM.h"
// the name of the Init function
#define SERV_4_INIT InitHSM
// the name of the run function
#define SERV_4_RUN RunHSM
// How big should this services Queue be?
#define SERV_4_QUEUE_SIZE 12
#endif
